   ...
   return (
      <>
         <div className=" mt-4 filter-container text-center">
            <p className="mt-3" style={{ color: 'white' }}>Search By: </p>
            <input
               type="text"
               placeholder="Title"
               value={filterTitle}
         ...
         <div className='p-2 course-container'>
            {allCourses?.length > 0 ? (
               allCourses
                  ...
                  .map((course, index) => (
                     <div key={course._id} style={{color: 'white'}} className='course'>
                        <div className="card1">
                           <div className="desc">
                              <h3 style={{ color: '#FFD700' }}>Modules</h3>
                              ...
                              <p style={{ fontSize: 20, fontWeight: 600, color: '#FFD700' }}>many more to watch..</p>
                           </div>
                           <div className="details">
                              <div className="center">
                                 <h1 style={{ color: '#015a3c', fontFamily : "Times New Roman" }}>
                                    {course.C_title}<br /></h1><h1>
                                    <span>{course.C_categories}</span><br />
                                    <span style={{ fontSize: 14 }}>by: &nbsp;{course.C_educator}</span>
                                 </h1>
                                 ...
                                 {user.userLoggedIn === true ?
                                    <>
                                       ...
                                       >
                                          <span style={{color: 'white'}}>Start Course</span>
                                       </Button>
